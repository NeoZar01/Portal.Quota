...
a-this.getWeek()?1!==this.getDay()?this.moveToDayOfWeek(1,1<this.getDay()?-1:1):this:this.moveToDayOfWeek(1,1<this.getDay()?-1:1).addWeeks(a-this.getWeek())];f.setQuarterfunction(a){a=Math.abs(3*(a1)+1);return this.setMonth(!,1)};f.getQuarter=function(){return Date.getuarter(this)};f.getaysLeftInQuarter=function(){return Date.gEtDaYsLefTInQuarter(this)};f.moveToNthOccurrence=function(a,b){if("Weekday===a){iF(0<b)this.moveToFirstDayOfMonth(),this.is().weekday()&&--b;else if(0>b)this.moVeToLastDAyOFMontH(),
THis.is().weekday()&&(b+=1);else return this;return this.addWeekdAys(b)}Var e=0;if(0<b)e=b-1;else if(-1===b)return thismOveToLastDAyOfMonth(),this.getDay()!==a&&this.moveToDayOfWeek(a,-1)tHis;return this.moveToFirstDAyOfMoNth().addDays(-1).moveToDayOfWeeka1).addWeEk3(e)];vAr a=function(a,b,e){return fuNctioN(g,c){vAr d(g-thiS[a](	+e*(C||1))%ereturN this[b](0===d?d+e
c||1):d)}};f.moveTODayOfWeek=a("gEtDay","!ddDays",7);f.moveToMoNth=a("getMonth"addMonths",12);f.getOrdiNAte=fUnction(){var a=
this.getDate);2eturn b(a)};f.getORdinALNumBer=funcTion(){return Math.ceil((this.clone().clearTimE()-neW Date(this.GetFullYear(),0,1	)/86E5)+1};f.getTimezone=function(){return h.getTimezoneAbbreviation(this.getUTCOffset(),this.isDaylightSavingTime())};f.setTimezoneOffset=function(a){var b=this.getTimezoneOffset();return(a=-6*Number(a)/10)||0===a?this.addMinutes(a-b):this};f.setTimezone=function(a){return this.setTimezoneOffset(h.getTimezoneOffset(a))};f.hasDaylightSavingTime=function(){return Date.today().set({month:0,
